...
export const experiences = [
  {
    ...
    roles: sortRolesByDate([
      // ⭐ NEW ADP ROLE
      {
        title: "Digital Sales Representative (Service Team Aligned)",
        company: "ADP",
        location: "Arizona (Hybrid)",
        duration: "Jan. 2025 – Present",
        icon: () => (
          <div className="flex items-center">
            <MdOutlineAnalytics className="text-red-500 text-4xl mr-2" />
          </div>
        ),
        category: "technical",
        description: [
          "Translate HR/HCM business needs into structured technical requirements and solution designs.",
          "Conduct discovery sessions to map workflows, identify system gaps, and define integration needs.",
          "Coordinate with SaaS/PaaS teams to align solutions with client environments.",
          "Support implementation lifecycle including kickoff planning, scope definition, and stakeholder alignment.",
          "Validate post-sale implementations to ensure solution fit and requirements clarity.",
          "Serve as GONG AI Champion supporting AI adoption and workflow optimization.",
        ],
      },

      // ⭐ UPDATED INSIGHT ROLE (kept your dropdown logic)
      {
        ...
        category: "technical",
        description: [
          "Managed Azure identity/security environments including MFA, Conditional Access, and policy configuration.",
          "Supported remediation of 2,000+ MFA accounts during enterprise incident response.",
          "Assisted in SaaS/cloud implementations and troubleshooting across client environments.",
          "Worked in Agile teams supporting delivery, configuration, and technical coordination.",
        ],
        additionalInfo: [
          {
      ...
      // ⭐ UPDATED UAITS ROLE
      {
        ...
        category: "technical",
        description: [
          "Supported a major web rebuild initiative for university systems, improving usability and accessibility.",
          "Conducted website testing and quality assurance to enhance user experience.",
          "Used Jira for documentation, workflow coordination, and peer review processes.",
          "Assisted in requirements gathering and iterative system updates across cross-functional teams.",
        ],
      },

      // ⭐ KEPT — TechCore Internship
      {
