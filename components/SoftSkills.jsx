...
const softSkills = [
    ...
    { name: 'Customer Service', icon: <FaRegHandshake className="text-3xl text-purple-600" /> },
    { name: 'Analytical Thinking', icon: <GiBrain className="text-3xl text-indigo-500" /> },
    { name: 'Project Management', icon: <FaClock className="text-3xl text-pink-500" /> },
    { name: 'Client Relations', icon: <FaRegHandshake className="text-3xl text-purple-600" /> },
    { name: 'Strategic Planning', icon: <FaLightbulb className="text-3xl text-yellow-400" /> },
    { name: 'Crisis Management', icon: <FaBalanceScale className="text-3xl text-blue-600" /> },
    { name: 'Mentoring', icon: <FaChalkboardTeacher className="text-3xl text-orange-500" /> },
    { name: 'Networking', icon: <FaUsers className="text-3xl text-green-500" /> },
    { name: 'Data Interpretation', icon: <GiMagnifyingGlass className="text-3xl text-green-600" /> },
    { name: 'Empathy', icon: <FaHeart className="text-3xl text-red-400" /> },
    { name: 'Collaboration', icon: <FaUsers className="text-3xl text-green-500" /> },
